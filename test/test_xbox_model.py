...
#   TODO refactor into function by function tests
...
class TestXboxModel(unittest.TestCase):
    ...
    def test_data_types(self):
        ...
        with self.assertRaises(TypeError):
            xm.set_trigger_offset("LEFT", True)

        with self.assertRaises(TypeError):
            xm.set_trigger_offset("LEFT", False)
        ...
        with self.assertRaises(TypeError):
            xm.set_stick_position("LEFT", "X", True)

        with self.assertRaises(TypeError):
            xm.set_stick_position("LEFT", "X", False)
